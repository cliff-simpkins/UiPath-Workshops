...
- **`MonsterSelector.uipx`** - solution manifest (generated by `uip solution new`). Contains local-only project UUIDs, no tenant info.
...
The upcoming Agent Evals lab assumes this agent is already uploaded to your tenant. If you completed the CLI-and-Agents lab, you're ready. If you deployed from this starter instead, the lab's first step ("confirm you have MonsterSelector in Studio Web") is already satisfied.
